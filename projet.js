...
const key = '?api_key=RGAPI-5efd2b00-bf96-4f13-9367-e35572026e30'
const url = 'https://euw1.api.riotgames.com/lol/summoner/'
...
.then(function (answers) {
  ...
  if (program.statinvoc) {
    ...
    let invoc = {}
    axios.get(url + 'v3/summoners/by-name/' + nominvoc + key)
